...
view.padding = {
  ...
  view.when(function() {
    ...
    if (zoomWidget) zoomWidget.style.top = '120px';   // Much more space below hamburger menu
    if (homeWidget) homeWidget.style.top = '200px';   // Below zoom buttons
    if (trackWidget) trackWidget.style.top = '240px'; // Below home button
  });
